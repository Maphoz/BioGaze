...
3. **Download Required Checkpoints**
   ...
   - You must download the face parser checkpoint from [this link]([https://example.com/face_parser_checkpoint](https://drive.google.com/file/d/1Hvd6tDmCVuF0KUtFIZQ_WXKlQvcHTQbm/view?usp=sharing)) and place it in `face_parser/res/cp` directory.
